...
export function storageDatabaseReset(database: StorageDatabase): Result<void> {
  ...
  try {
    return database.db.transaction((transaction) => {
      ...
      transaction.run("DROP INDEX IF EXISTS event_user_subjects_realm_user_position_idx")
      transaction.run("DROP INDEX IF EXISTS users_realm_id_id_idx")
      ...
      transaction.run("DROP INDEX IF EXISTS whatsapp_otp_challenges_realm_phone_idx")
      transaction.run("DROP INDEX IF EXISTS whatsapp_otp_challenges_realm_user_idx")
      transaction.run("DROP INDEX IF EXISTS waha_health_candidates_fresh_idx")
      transaction.run("DROP INDEX IF EXISTS user_email_change_challenges_token_hash_idx")
      transaction.run("DROP INDEX IF EXISTS user_email_change_challenges_realm_user_email_idx")
      transaction.run("DROP INDEX IF EXISTS users_realm_verified_phone_idx")
      transaction.run("DROP INDEX IF EXISTS user_emails_realm_user_idx")
      transaction.run("DROP INDEX IF EXISTS user_emails_realm_email_idx")
      transaction.run("DROP INDEX IF EXISTS user_emails_one_primary_idx")
      transaction.run("DROP INDEX IF EXISTS user_profile_picture_cleanup_created_at_idx")
      transaction.run("DROP INDEX IF EXISTS user_profile_picture_cleanup_lifecycle_idx")
      ...
      transaction.run("DROP INDEX IF EXISTS password_registration_challenges_realm_user_idx")
      transaction.run("DROP INDEX IF EXISTS password_registration_challenges_realm_identity_idx")
      transaction.run("DROP INDEX IF EXISTS password_registration_challenges_decoy_identity_idx")
      transaction.run("DROP INDEX IF EXISTS password_registration_challenges_code_hash_idx")
      ...
      transaction.run("DROP INDEX IF EXISTS oidc_interactions_realm_idx")
      transaction.run("DROP INDEX IF EXISTS oidc_interactions_expiry_idx")
      ...
      transaction.run("DROP TABLE IF EXISTS event_user_subjects")
      ...
      transaction.run("DROP TABLE IF EXISTS oidc_interactions")
      ...
      transaction.run("DROP TABLE IF EXISTS whatsapp_otp_challenges")
      transaction.run("DROP TABLE IF EXISTS waha_health_candidates")
      transaction.run("DROP TABLE IF EXISTS password_challenges")
      transaction.run("DROP TABLE IF EXISTS password_registration_challenges")
      transaction.run("DROP TABLE IF EXISTS rate_limits")
      ...
      transaction.run("DROP TABLE IF EXISTS user_email_change_challenges")
      transaction.run("DROP TABLE IF EXISTS user_emails")
      transaction.run("DROP TABLE IF EXISTS user_profiles")
      transaction.run("DROP TABLE IF EXISTS user_profile_picture_cleanup")
