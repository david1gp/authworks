...
export function storageDatabaseReset(database: StorageDatabase): Result<void> {
  ...
  try {
    return database.db.transaction((transaction) => {
      ...
      transaction.run("DROP INDEX IF EXISTS organization_domains_instance_idx")
      ...
      transaction.run("DROP INDEX IF EXISTS passkey_credentials_instance_user_idx")
      transaction.run("DROP INDEX IF EXISTS passkey_credentials_instance_rp_idx")
      transaction.run("DROP INDEX IF EXISTS passkey_ceremonies_token_hash_idx")
      transaction.run("DROP INDEX IF EXISTS passkey_ceremonies_instance_expiry_idx")
      transaction.run("DROP INDEX IF EXISTS passkey_ceremonies_instance_user_idx")
      ...
      transaction.run("DROP TABLE IF EXISTS instance_login_policies")
