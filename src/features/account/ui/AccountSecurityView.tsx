            ...
            >
              <div class="grid gap-3" data-security-history-list>
                <For each={props.state.securityHistory()}>
                  {(item) => (
                    <article class="rounded-2xl border border-line bg-surface p-5 shadow-sm" data-security-history-item>
                      <div class="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                        ...
                        <time class="text-sm text-muted-foreground" dateTime={new Date(item.occurredAt).toISOString()}>
