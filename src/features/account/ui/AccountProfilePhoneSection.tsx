      ...
      secondary={
        ...
        >
          <div class="grid gap-2.5 px-3 py-3">
            ...
            >
              <form
                class="grid gap-2.5 rounded-control border border-line-subtle px-2.5 py-2.5"
      ...
      primary={
        ...
        >
          <Show
            ...
            fallback={
              <ProductionStatePanel compact state="empty" title={messageTranslate("account.profile.phoneNotAdded")} />
            }
          >
            {(phoneNumber) => (
              <div class="grid min-w-0 gap-0.5 px-3 py-2.5">
                <p class="text-2xs font-semibold tracking-[0.12em] uppercase text-muted-foreground">
                  {messageTranslate("account.profile.phoneNumber")}
                </p>
                <p class="min-w-0 truncate font-mono text-sm">{phoneNumber()}</p>
              </div>
            )}
          </Show>
        </AuthenticatedSection>
