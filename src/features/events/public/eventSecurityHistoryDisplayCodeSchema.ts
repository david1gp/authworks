...
export const eventSecurityHistoryDisplayCodeSchema = v.picklist([
...
export type EventSecurityHistoryDisplayCode = v.InferOutput<typeof eventSecurityHistoryDisplayCodeSchema>
