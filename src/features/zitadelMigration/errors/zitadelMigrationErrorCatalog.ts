...
export const zitadelMigrationErrorCatalog = [
  ...
  { code: "zitadel-migration.invalid-plan", httpStatus: 400, retryable: false },
  ...
  { code: "zitadel-migration.source-incomplete", httpStatus: 503, retryable: false },
  { code: "zitadel-migration.authoritative-incomplete", httpStatus: 409, retryable: false },
  ...
  { code: "zitadel-migration.source-mismatch", httpStatus: 409, retryable: false },
  { code: "zitadel-migration.read-failed", httpStatus: 500, retryable: false },
  { code: "zitadel-migration.write-failed", httpStatus: 500, retryable: false },
