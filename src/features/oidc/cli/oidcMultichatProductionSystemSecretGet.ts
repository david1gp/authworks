...
export async function oidcMultichatProductionSystemSecretGet(homeDirectory: string): Promise<Result<Secret>> {
  const op = "oidcMultichatProductionSystemSecretGet"
