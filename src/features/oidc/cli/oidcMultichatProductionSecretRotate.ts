...
export async function oidcMultichatProductionSecretRotate(options: {
  ...
  const op = "oidcMultichatProductionSecretRotate"
  ...
  if (credentialEnvelope === undefined)
    return resultErrorCodedCreate(
      op,
      "The rotated Multichat production credential envelope was not created.",
      "platform.internal",
    )
  try {
    ...
    return resultErrorCodedCreate(
      op,
      "The rotated Multichat production credential could not be handed off.",
      "platform.internal",
    )
  }
