...
export function machineSecretHashCreate(
  ...
  try {
    ...
    if (salt.length !== 16) return resultErrorCreate(op, "The machine secret could not be hashed.")
    ...
    return resultErrorCreate(op, "The machine secret could not be hashed.")
  }
}
