...
/**
 * Local view state for the one-time credential panel. The secret is only ever read from the
 * accessor it is given; it is never copied into storage, a URL, or a log.
 */
export function machineAdminSecretPanelStateCreate(options: {
