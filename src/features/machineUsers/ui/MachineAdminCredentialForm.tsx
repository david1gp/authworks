    ...
    <form class="grid gap-4" onSubmit={state.submit}>
      <div class="grid gap-2">
        ...
        <SelectSingleNative
          ...
          valueSignal={{ get: state.kind, set: (kind) => props.kindSet(kind as "api_key" | "personal_access_token") }}
          valueText={(kind) =>
            kind === "api_key"
        ...
        />
        <p class="text-xs text-muted-foreground">{messageTranslate("admin.machine.credentials.kindHint")}</p>
      </div>
      <div class="grid gap-2">
      ...
      <div class="grid gap-2">
        ...
        />
        <p class="text-xs text-muted-foreground">{messageTranslate("admin.machine.credentials.scopesHint")}</p>
      </div>
      <div class="grid gap-2">
        ...
        />
        <p class="text-xs text-muted-foreground">{messageTranslate("admin.machine.credentials.expiresHint")}</p>
      </div>
