...
export const organizationLoginPolicyTable = sqliteTable("organization_login_policies", {
  ...
  requiredMfa: integer("required_mfa", { mode: "boolean" }),
  allowedFactors: text("allowed_factors"),
  preferredFactorOrder: text("preferred_factor_order"),
  minimumStepUpAssurance: text("minimum_step_up_assurance"),
