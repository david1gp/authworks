...
export const realmLoginPolicyTable = sqliteTable("realm_login_policies", {
  ...
  requiredMfa: integer("required_mfa", { mode: "boolean" }).notNull(),
  allowedFactors: text("allowed_factors").notNull(),
  preferredFactorOrder: text("preferred_factor_order").notNull(),
  minimumStepUpAssurance: text("minimum_step_up_assurance").notNull(),
