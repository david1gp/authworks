  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        key: "user-detail",
        title: "User detail",
        description: "Review profile, lifecycle, sessions, and safe authentication metadata.",
      ...
      },
      {
        ...
        description: "Review safe factor, passkey, and recovery metadata on user detail.",
        path: "/demo/admin/users/01900000-0000-7000-8000-000000000021/authentication",
        availability: "available",
      ...
      },
      {
        ...
        path: "/demo/admin/users/01900000-0000-7000-8000-000000000021/sessions",
        availability: "available",
        states: [...collectionStates],
      },
      {
