  ...
  return (
    <div class="min-h-dvh bg-gray-50 dark:bg-gray-950">
      <Sidebar
        ...
        desktopChildren={
          <aside class="fixed inset-y-0 left-0 z-20 w-64 border-r border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
...
function AdminSidebarContent(props: { state: ReturnType<typeof adminDemoAppStateCreate> }) {
  return (
    <div class="grid gap-2">
      ...
      <nav aria-label="Administration" class="grid gap-1">
        {props.state.navigation.map((item) => (
          <A
