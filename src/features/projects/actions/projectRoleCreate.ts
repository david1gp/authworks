...
export function projectRoleCreate(options: ProjectRoleCreateOptions): Result<{ role: ProjectRole }> {
  ...
  if (!parsed.success) return resultErrorCreate(op, "The project role request is invalid.")
  ...
  return storageTransactionRun(options.database, (transaction) => {
    ...
    if (duplicate.data !== null) return resultErrorCreate(op, "A project role with that key already exists.")
