...
- Level 3 includes realms, organizations, memberships, invitations, organization switching, roles, permissions, and tenant isolation.
...
- Level 6 includes multiple organizations per realm, organization branding and identity-provider configuration, account linking, domain discovery, machine users, personal access tokens, client credentials, projects/applications/roles, cross-organization grants, fine-grained policy evaluation, and admin impersonation.
...
- [x] 4. Implement realms and bootstrap administration with strict tenant context and isolation tests.
...
- [x] 11. Implement external identities and safe account linking, then Google, GitHub, and Microsoft providers with realm/organization configuration.
...
- [x] 16. Implement machine users, client credentials, personal access tokens, API keys, rotation, and revocation.
- [x] 17. Implement organization branding, domain discovery, and organization-specific login/provider policy.
...
- CLI connection profiles plan: `docs/20260825_cli_connection_profiles.md`
